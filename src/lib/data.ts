...
export const quizzes: Quiz = {
  ...
  "coding-quest-computer-science-11": {
    questions: [
        ...
        { text: "What is a 'framework' in web development (e.g., React, Angular)?", options: ["A type of database", "A library of functions", "A foundation with a set of tools and conventions to build applications", "A style guide for CSS"], correctAnswer: "A foundation with a set of tools and conventions to build applications" },
        { text: "What does SQL stand for?", options: ["Structured Query Language", "Simple Question Language", "Standard Query Logic", "System Query Language"], correctAnswer: "Structured Query Language" },
        { text: "What is 'encapsulation' in Object-Oriented Programming?", options: ["The process of converting code to machine language", "The bundling of data with the methods that operate on that data", "A way to make all variables public", "A type of inheritance"], correctAnswer: "The bundling of data with the methods that operate on that data" },
        { text: "Which HTTP status code means 'Not Found'?", options: ["200", "301", "404", "500"], correctAnswer: "404" },
        { text: "What is the main function of a DNS (Domain Name System) server?", options: ["To host websites", "To translate domain names into IP addresses", "To send emails", "To secure a network"], correctAnswer: "To translate domain names into IP addresses" },
        { text: "What is 'asynchronous' programming?", options: ["Code that runs in a single, sequential order", "Code that allows multiple operations to run concurrently without waiting for each other", "A way to write code without functions", "A type of error"], correctAnswer: "Code that allows multiple operations to run concurrently without waiting for each other" },
        { text: "What is JSON?", options: ["A Java-based scripting language", "A lightweight data-interchange format", "A type of server", "A database management system"], correctAnswer: "A lightweight data-interchange format" },
        { text: "What is the 'C' in the 'CRUD' acronym for database operations?", options: ["Change", "Copy", "Create", "Count"], correctAnswer: "Create" },
        { text: "In web development, what is the 'DOM'?", options: ["A type of file storage", "A programming interface for HTML and XML documents", "A network protocol", "The Domain of the website"], correctAnswer: "A programming interface for HTML and XML documents" },
        { text: "What is a 'cookie' in the context of web browsing?", options: ["A small piece of data sent from a website and stored on the user's computer", "A type of pop-up ad", "A virus", "A piece of tracking software"], correctAnswer: "A small piece of data sent from a website and stored on the user's computer" }
    ]
  },
  ...
  "coding-quest-computer-science-12": {
    questions: [
        ...
        { text: "What is the OSI model?", options: ["A model for object-oriented programming", "A conceptual framework for network communication", "A type of computer architecture", "A database schema"], correctAnswer: "A conceptual framework for network communication" },
        { text: "What is a container (like Docker)?", options: ["A physical server", "A lightweight, standalone, executable package of software that includes everything needed to run it", "A type of variable", "A version control system"], correctAnswer: "A lightweight, standalone, executable package of software that includes everything needed to run it" },
        { text: "In cryptography, what is the difference between symmetric and asymmetric encryption?", options: ["Symmetric is more secure", "Symmetric uses the same key for encryption and decryption, while asymmetric uses different keys", "Asymmetric is faster", "Symmetric is for files, asymmetric is for networks"], correctAnswer: "Symmetric uses the same key for encryption and decryption, while asymmetric uses different keys" },
        { text: "What is a 'lambda function' or 'anonymous function'?", options: ["A function with no name", "A function that can only be called once", "A function that is part of a class", "A function that connects to a database"], correctAnswer: "A function with no name" },
        { text: "What is a RESTful API?", options: ["An API that is very fast", "An architectural style for designing networked applications", "An API that only uses the POST method", "An API for resting a server"], correctAnswer: "An architectural style for designing networked applications" },
        { text: "What is the purpose of the 'finally' block in a try-catch-finally statement?", options: ["To catch all errors", "To execute code only if an error occurs", "To execute code regardless of whether an error occurred or not", "To finalize the program and exit"], correctAnswer: "To execute code regardless of whether an error occurred or not" },
        { text: "What is a 'pointer' in languages like C/C++?", options: ["A variable that stores a single character", "A variable that stores the memory address of another variable", "A reference to a file", "A special type of integer"], correctAnswer: "A variable that stores the memory address of another variable" },
        { text: "What is a 'build tool' like Maven or Gradle?", options: ["A code editor", "A tool that automates the creation of executable applications from source code", "A debugging utility", "A database client"], correctAnswer: "A tool that automates the creation of executable applications from source code" },
        { text: "What is a 'Content Delivery Network' (CDN)?", options: ["A type of local network", "A system of distributed servers that deliver web content to a user based on their geographic location", "A service for streaming video", "A brand of internet service provider"], correctAnswer: "A system of distributed servers that deliver web content to a user based on their geographic location" },
        { text: "What is OAuth?", options: ["An authentication protocol", "An open standard for access delegation, commonly used as a way for Internet users to grant websites or applications access to their information on other websites but without giving them the passwords", "A type of encryption", "A JavaScript library"], correctAnswer: "An open standard for access delegation, commonly used as a way for Internet users to grant websites or applications access to their information on other websites but without giving them the passwords" }
    ]
  },
